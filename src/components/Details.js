                ...
                <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                    <div className="p-4 md:w-1/2 flex">
                        ...
                        <div className="flex-grow pl-6">
                            <h2 className="text-gray-900 text-lg title-font font-medium mb-2">START DATE</h2>
                            <p className="leading-relaxed text-base">2022-06-26 16:38:05</p>
                            <p className="mt-3 text-indigo-500 inline-flex items-center">Ends in 0 days
                            </p>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/2 flex">
                        ...
                        <div className="flex-grow pl-6">
                            <h2 className="text-gray-900 text-lg title-font font-medium mb-2">TARGET RAISE</h2>
                            <p className="leading-relaxed text-base">5000000</p>
                            <p className="mt-3 text-indigo-500 inline-flex items-center"> 0% Raised So far
